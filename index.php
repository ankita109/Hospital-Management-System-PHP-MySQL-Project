...
?>
                        ...
                        <?php echo "Designed by Ankita Dubey ";?> <br>  
                        <?php echo "Lovely Professional University, Phagwara" ?> <br>
                        Phone: <?php  echo "8219138466";?> <br>
                        Email: <a href="mailto:<?php  echo "ankita@test.com";?>" class=""><?php  echo $row['Email'];?></a><br>
                        Timing: <?php  echo "10:00 - 18:00";?>
                    </address>
    ...
    <div class="copy">
            <div class="container">
         Hospital Management System BY Ankita
